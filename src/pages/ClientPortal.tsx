...
export function ClientShop() {
  ...
  return <div className="stack client-page private-shop">
    <div className="shop-hero"><span className="landing-kicker">Acceso anticipado para miembros</span><h1>Cava Privada</h1><p>Compra nuevas llegadas de Divinos y botellas verificadas de otros miembros. Al pagar, quedan automáticamente en tu cava.</p><Link className="btn secondary" to="/sell">Vender una botella de mi colección</Link></div>
